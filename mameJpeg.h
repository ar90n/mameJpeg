...
bool mameJpeg_decodeDC( mameJpeg_context* context, uint8_t component_index, bool* has_data )
{
    MAMEJPEG_NULL_CHECK( context );
...
bool mameJpeg_decodeAC( mameJpeg_context* context, uint8_t component_index, bool* has_data )
{
    *has_data = false;
    uint8_t elem_num = 1;
    while( elem_num < 64 )
